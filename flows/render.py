...
from lib.models.render import RenderJob
...
@flow
def render(render_job: RenderJob) -> dict:
    """
    ...
    job_dict = {
        "input": {
            ...
            "parameters": render_job.model_dump(),
            # Optional parameters
